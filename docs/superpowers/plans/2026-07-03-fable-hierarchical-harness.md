...
- [ ] **Step 1: `CEO_SCHEMA` 정의 바로 뒤에 `MANAGER_SCHEMA`와 `managerPrompt` 추가**
...
- [ ] **Step 3: 임시 `return ceoPlan`을 팀장 세분화 호출 + 임시 return으로 교체**
...
- [ ] **Step 1: `MANAGER_SCHEMA` 뒤에 `WORK_RESULT_SCHEMA` 추가**
...
- [ ] **Step 2: `managerPrompt` 뒤에 `workerPrompt`, `codexWrapperPrompt`, `routeWorkItem` 추가**
...
- [ ] **Step 3: 임시 return을 팀원 실행 단계 + 임시 return으로 교체**
...
- [ ] **Step 1: `WORK_RESULT_SCHEMA` 뒤에 `REVIEW_SCHEMA` 추가**
...
- [ ] **Step 2: `routeWorkItem` 함수 뒤에 `reviewPrompt`와 `runTeamCycle` 추가**
...
- [ ] **Step 3: CEO 설계 이후 코드를 `runTeamCycle` 호출 + 임시 return으로 교체**
...
- [ ] **Step 1: `REVIEW_SCHEMA` 뒤에 `CEO_FINAL_SCHEMA` 추가**
...
- [ ] **Step 2: `reviewPrompt` 뒤, `runTeamCycle` 앞에 `ceoFinalPrompt` 추가**
...
- [ ] **Step 3: 임시 return을 CEO 최종검수 + 최종 return으로 교체**
...
- [ ] **Step 4: 전체 end-to-end 실제 호출로 검증**
...
- [ ] **Step 3: frontmatter YAML 유효성 확인**
